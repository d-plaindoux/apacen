...
subst(T[X:=Y],T,unbound(T[X:=Y]))                            :- unbound(X),const0(Y),!,equals(X,Y).
subst(T[X:=Y],T,unbound(T[X:=Y]))                            :- unbound(X),!.
subst(T[X:=Y],T,unbound(T[X:=Y]))                            :- unbound(Y),!,equals(X,Y).
subst(T[X:=Y],R,unbound(T[X:=Y]))                            :- unbound(T),!,equals(T[X:=Y],R).
